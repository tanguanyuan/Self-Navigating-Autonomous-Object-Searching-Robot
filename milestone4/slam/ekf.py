...
class EKF:
    ...
    def __init__(self, robot):
        ...
        self.init_lm_cov = 0 #Default: 0.01 # initial covariance of [lm_x, lm_y] # 1e3 # default 
        
        # cumulatives variances of R and Q, the idea is to keep it on edge so that it will correct its states
        self.R0 = 0 # theoretical 0.0025 #Default: 0.01 # minimum/cumulative covariance of measurement # default 0.01 
        # self.Q0 = 0.1 #Default: 0.1 # minimum/cumulative covariance of states # default 0.1 # not used anymore
        self.Q0_xy = 0.0006
        ...
        self.lm_pics.append(pygame.image.load(f_))
        self.pibot_pic = pygame.image.load(f'./pics/8bit/pibot_top_flip.png')
